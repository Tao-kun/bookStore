...
class User(models.Model):
    ...
    city = models.CharField(max_length=20, null=True, blank=True, verbose_name='城市')  # 在select下拉菜单中的值，也就是城市的value
    city_num = models.IntegerField(null=True, blank=True, verbose_name='城市编号')  # 在select下拉菜单中的编号
    detail_address = models.CharField(max_length=255, null=True, blank=True, verbose_name='详细地址')
    zip_code = models.CharField(max_length=20, null=True, blank=True, verbose_name='邮编')
    ...
    money = models.FloatField(default=0, null=True, blank=True, verbose_name='账户余额')
